...
// Add and Edit Modal Handling
        $('#addButton').click(function () {
            ...
            myModal.show();
            $('#dataModalLabel').text('Add New Component  Type Name');
        ...
        $(document).off('click', '.editButton').on('click', '.editButton', function () {
            ...
            $.get('/component_types/' + id + '/edit', function (data) {
                $('#dataModalLabel').text('Edit Component  Type Name');
                $('#recordId').val(data.id);
                $('#component_type_name').val(data.component_type_name);
                $('input[name="component_type_status"][value="' + data.component_type_status + '"]').prop('checked', true);
            });
        });
        ...
        $("#dataForm").validate({
            ...
            messages: {
                component_type_name: {
                    required: "Component  Type Name is required.",
                    //pattern: "Special characters are not allowed in the Component  Type Name name.",
                },
                component_type_status: {
            ...
            submitHandler: function (form) {
                ...
                const url = $('#recordId').val() ? '/component_types/' + $('#recordId').val() 
                                                : '/component_types'; 
        ...
        $(document).on('click', '.delete-btn', function () {
            ...
            const url = '/component_types/' + itemId ;
