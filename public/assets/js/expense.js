...
//                         $("#amount").siblings(".invalid-feedback").text("Insufficient Balance").show();
//                         $('#saveBtn').prop('disabled', true); 
//                     } else {
//                         $("#amount")
//                             .addClass("is-valid")
//                             .removeClass("is-invalid");
//                         $("#amount").siblings(".invalid-feedback").hide();
...
$(document).ready(function () {
    $.validator.addMethod("checkBalance", function(value, element) {
            ...
            $.ajax({
                ...
                data: {
                    amount: value,
                    trans_type: $('#transaction_type').val(),
                    id: $('#recordId').val()
                },
                async: false, // synchronous so jQuery Validate waits
                success: function(response) {
                    isValid = (response.flag == 0); // flag==0 means sufficient balance
                }
            });
            return isValid;
