...
// Add and Edit Modal Handling
        $('#addButton').click(function () {
            ...
            myModal.show();
            $('#dataModalLabel').text('Add New Brand Name');
        ...
        $(document).off('click', '.editButton').on('click', '.editButton', function () {
            ...
            $.get('/brands/' + id + '/edit', function (data) {
                $('#dataModalLabel').text('Edit Brand Name');
                $('#recordId').val(data.id);
                $('#brand_name').val(data.brand_name);
                $('input[name="brand_status"][value="' + data.brand_status + '"]').prop('checked', true);
            });
        });
        ...
        $("#dataForm").validate({
            ...
            submitHandler: function (form) {
                ...
                const url = $('#recordId').val() ? '/brands/' + $('#recordId').val() 
                                                : '/store_brand'; 
        ...
        $(document).on('click', '.delete-btn', function () {
            ...
            const url = '/brands/' + itemId +'/destroy';
