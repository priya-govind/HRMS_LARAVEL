...
if(instance.listNumber==1){
var addnewclass='test1';
} else if(instance.listNumber==2){
var addnewclass='test2';
}else {
var addnewclass='test3';
}

            // add option container
            $(instance.element).after('<div id="ms-list-'+ instance.listNumber +'" class="ms-options-wrap '+addnewclass+'"><button type="button"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
