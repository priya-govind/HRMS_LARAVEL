      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <button type="button" id="addButton" class="btn btn-primary btn-sm">+Add New Category
                </div>
            </div>
                    <div class="card-body">
                    @if (session('success'))
            ...
            <div class="modal-body">
                ...
                <form id="dataForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="category_name" name="category_name" pattern="[a-zA-Z0-9\s]*" title="Special Characters not allowed">
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Category URL</label>
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Category Status:</label>&nbsp;&nbsp;
                        <input type="radio" class="form-check-input" id="is_active_cat" name="is_active_cat" value="1" required> Active &nbsp;&nbsp;
                        <input type="radio" class="form-check-input" id="is_active_cat" name="is_active_cat" value="0" required>Inactive
                    </div>
                    <div class="mb-3">
