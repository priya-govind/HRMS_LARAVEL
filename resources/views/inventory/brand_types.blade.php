            ...
            <div class="card-header">
                <div class="float-start">
                 ...
                 @can('PagePermit', ['global.categories', config('global_permissions.Add')])
                    <div class="float-end">
                        <button type="button" id="addButton" class="btn btn-primary btn-sm">+Add New Brand
                    </div>
                @endcan
            </div>
                    <div class="card-body">
        ...
        <div class="modal-content logic_cont">
            ...
            <div class="modal-body">
                ...
                <form id="dataForm">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Brand Status:</label>&nbsp;&nbsp;
                        <input type="radio" class="form-check-input" id="brand_status" name="brand_status" value="1" required> Active &nbsp;&nbsp;
                        <input type="radio" class="form-check-input" id="brand_status" name="brand_status" value="0" required>Inactive
                    </div>
