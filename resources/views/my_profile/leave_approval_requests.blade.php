        ...
        <div class="main-panel">
          ...
          <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="float-end">
                    <button class="btn btn-primary btn-sm permit_popup" id="permit_popup">Set Leave Approval Rights </button>
                </div>
                @endif
            </div> 
              <div class="card-body">
            <div class="row">
              <div class="col-md-12 search">
                <form id="FilterForm" class="LeaveForm" method="post">
                    @csrf
                  <h5><b> Search For Leave Requests for Approval</b></h5><br/>
                     <div class=" row mb-3">
                        <label for="name" class="form-label">Filter By:</label>
                          ...
                          <div class="col-md-2 mb-3">
                              <input type="text" class="form-control" id="to_dt_search" name="from_dt_search" placeholder="To Date">
                          </div>
                                 <div class="col-md-2 mb-3">
        ...
        <div class="modal-content logic_cont">
            ...
            <div class="modal-body">
                ...
                <form id="dataForm">
                    ...
                    <div class="form-group leave_cl">
                        <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="name" class="form-label">From Date:</label>
                                    <input type="text" class="form-control" id="from_dt1" name="from_dt1" readonly>
                                </div>
                                <div class="col-md-5">
                                    <label for="name" class="form-label">To Date:</label>
                                    <input type="text" class="form-control" id="to_dt1" name="to_dt1" readonly> 
                                </div>
                        </div>
                    </div>
                      <div class="form-group permit_cl">
                           <div class="row">
                              <div class="col-md-5 mb-3">
                                    <label for="name" class="form-label">Date:</label>
                                </div>
                                <div class="col-md-5 mb-3">
                                    <input type="text" class="form-control" id="permission_dt1" name="permission_dt1" readonly>
                              </div>
                           </div>
                          <div class="row">
                              <div class="col-md-5 mb-3">
                                  <label for="name" class="form-label">From Time:</label>
                                  <input type="text" class="form-control" id="from_time1" name="from_time1" readonly>
                              </div>
                              <div class="col-md-5 mb-3">
                                  <label for="name" class="form-label">To Time:</label>
                                  <input type="text" class="form-control" id="to_time1" name="to_time1" readonly>
                              </div>
                          </div>
                      </div>
                      <div class="form-group">
                        <div class="row mb-3">
                                ...
                                <div class="col-md-5"> 
                                    <textarea id="reason1" class="form-control" readonly> </textarea>
                                </div> 
                        </div>
                    </div>
                   
                    {{-- This div viewed for other request except approved request --}}
                    @if($result || in_array(session('role_id'),config('global.all_in_all_access')))
                    <div class="approve_permit">
                    <input type="hidden" name="UserId" id="UserId" value="{{ session('user_id') }}" >
                    <div class="form-group">
                        <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="name" class="form-label">Leave Request:</label>
                                </div>
                                <div class="col-md-5"> 
                                     <input type="radio" class="form-check-input leave_status" name="leave_status" value="1"> Approve &nbsp;&nbsp;
                                     <input type="radio" class="form-check-input leave_status" name="leave_status" value="2" >Deny
                                </div> 
                        </div>
                    </div>
                    <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary" id="saveBtn">Approve</button>
                  <img class="sender_load" src="{{url('assets/images/small_load.gif')}}" style="margin: 0 25% 0 0;display:none;"/>
                   ...
                   <button type="button" class="btn btn-danger" style="margin: 9px 0 0 0;" data-bs-dismiss="modal">Close</button>
                    ...
                    {{-- This div viewed only for approved request --}}
                    <div class="view_permit">
                    <div class="mb-3">
                      ...
                      <div class="mb-3" id="leave_cmt" style="display:none">
                        <label for="name" class="form-label">Comments Added will Updating Your Request:</label>
  ...
  <div class="modal fade" id="PermissionModal" tabindex="-1" aria-labelledby="PermissionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content logic_cont">
            ...
            <div class="modal-body">
                <div id="permit_success" class="alert alert-success" role="alert" style="display: none;"></div>
                <div id="permit_error" class="alert alert-danger" style="display: none;"></div>
                <form id="assignForm" method="POST">
                    @csrf
                    <input type="hidden" id="module_name" name="module_name" value="leave_module" />
                        <div class="mb-3">
                          <label for="name" class="form-label">Assign To</label>
                              <div class="checkbox-container">
                                @if(!empty($control_teams)) 
                                  @foreach ($control_teams as $emp)
                                      <label class="checkbox-item">
                                          <input type="checkbox" class="roleCheckbox" name="ctrl_id[]" value="{{ $emp->id }}">
                                          {{ $emp->name }}
                                      </label>
                                  @endforeach
                                @endif
                      ...
                      <button type="submit" class="btn btn-primary" id="permitBtn">Save</button>
                   <button type="button" class="btn btn-danger" style="margin: 9px 0 0 0;" data-bs-dismiss="modal">Close</button>
                </form>
            </div>
        </div>
...
$(document).ready(function () {
    ...
    $('#LeaveTable').DataTable({
        ...
        autoWidth: false,
       ajax: {
              url: "{{ route('attendance.leave_approval_requests') }}",
              type: "GET",
              data: function (d) {
